...
- Home Assistant 2025.x+ (HACS manifest currently gates at 2024.1.0 — pending bump)
...
- All PRs require passing CI and a clean Codex review before merge. Merges are manual — no auto-merge.
