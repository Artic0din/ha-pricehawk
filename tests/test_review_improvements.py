...
class TestConfigFlowWindows:
    def test_overlap_midnight_cross(self):
        ...
        result = _validate_no_overlap("23:00-01:00", "00:30-02:00", "02:00-23:00")
    ...
    def test_coverage_gap_minute(self):
        ...
        assert (
            _validate_full_coverage("16:00-23:00", "23:00-11:00, 14:30-16:00", "11:00-14:00")
            is False
        )
...
class TestLocalVoltsAggregation:
    ...
    def test_missing_load_field_mean(self):
        ...
        ivs = [
            {
                "intervalEnd": "2026-05-01T12:00:00Z",
                "costsAllVarRate": 30.0,
                "earningsAllVarRate": 5.0,
                "quality": "exp",
            },
            {
                "intervalEnd": "2026-05-01T12:05:00Z",
                "costsAllVarRate": 10.0,
                "earningsAllVarRate": 1.0,
                "quality": "exp",
            },
        ]
