...
def test_setup_writes_runtime_data():
    ...
    p1, p2, p3, p4, p5 = _patch_deps(coord)
    with p1, p2, p3, p4, p5:
...
def test_multi_entry_service_lifecycle():
    ...
    p1, p2, p3, p4, p5 = _patch_deps_iter([coord_a, coord_b])
    with p1, p2, p3, p4, p5:
...
def test_options_flow_reload_cycle():
    ...
    p1, p2, p3, p4, p5 = _patch_deps_iter([coord_v1, coord_v2])
    with p1, p2, p3, p4, p5:
        asyncio.run(async_setup_entry(hass, entry))
...
def test_service_handlers_resolve_fresh_coordinator():
    ...
    p1, p2, p3, p4, p5 = _patch_deps(original_coord)
    with p1, p2, p3, p4, p5:
        asyncio.run(async_setup_entry(hass, entry))
